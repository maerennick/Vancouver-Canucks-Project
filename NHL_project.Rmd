...
teams_2007_2016<- read_csv("MP_data", "teams_2007_2016.csv")
teams_2017_2023<- read_csv("MP_data", "teams_2017_2023.csv")
...
canucks_shot_data<- read_csv(here("MP_data", "shots_2007-2021.csv")) %>% 
...
canucks_data_long <- canucks_team_data %>% 
  dplyr::select(-team, -name, -player_team, -home_or_away, -game_date, -position, -situation, -game_id, -opposing_team, -opposing_ice_time, -missed_shots_for, -opposing_shots_on_goal,-rebound_goals_for, -missed_shots_for, -x_on_goal_for, -penalties_served, -penalties_drawn, -opposing_rebound_goals, -shot_attempts_for) %>% 
